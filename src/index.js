...
function getWeather(city) {
    ...
    axios.get(url + city).then(res => {
        ...
        fetch('https://api.giphy.com/v1/gifs/search?api_key=CrpHODR2TAesMkW7XQc3ZAV0BcfOvLpk&q=rainy+day&limit=25&offset=0&rating=g&lang=en&bundle=messaging_non_clips').then(
            res => res.json()).then(data => {
                console.log(data);
                document.body.style.backgroundImage = `url('${data.data[Math.floor(Math.random(10) * 10)].images.original.url}')`;
